...
let table = await fromUuid("Compendium.ironsworn-custom-oracles.ironsworncustomoracles.RollTable.vt3n9TYeQr6sQUVz");

let Roll = await table.roll();
CorpFront = Roll.results[0].data.text;

// table = game.tables.getName("Corporate - Back Name");
table = await fromUuid("Compendium.ironsworn-custom-oracles.ironsworncustomoracles.RollTable.0GtuQnwiClCBnknY");
Roll = await table.roll();
CorpBack = Roll.results[0].data.text;

// table = game.tables.getName("Corporate - Crime");
table = await fromUuid("Compendium.ironsworn-custom-oracles.ironsworncustomoracles.RollTable.YUbKhY7DV72tES3i");
Roll = await table.roll();
Crime = Roll.results[0].data.text;

// table = game.tables.getName("Corporate - Method");
table = await fromUuid("Compendium.ironsworn-custom-oracles.ironsworncustomoracles.RollTable.3YicVtK49eI2g87F");
Roll = await table.roll();
